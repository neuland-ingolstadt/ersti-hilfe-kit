        ...
        >
          ...
          {data.map((elem, idx) => (
            ...
            >
              ...
              >
                <h4 className={styles.popupHeading}>{elem.title}</h4>
                ...
                <p>
                  Öffnen in{' '}
                  <a
                    href={getOSMLink(elem.lat, elem.lon)}
                    target="_blank"
                    rel="noreferrer"
                  >
                    OpenStreetMap
                  ...
                  {', '}
                  <a
                    href={getGoogleMapsLink(elem.lat, elem.lon)}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Google Maps
                  ...
                  {', '}
                  <a
                    href={getAppleMapsLink(elem.title, elem.lat, elem.lon)}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Apple Maps
