    ...
    <>
      ...
      <Container className={styles.container}>
        <main className={styles.main}>
          <h2 className={styles.title}>Dein Campus</h2>

          <p>
            Die THI hat zwei Hochschulgelände. Der Campus der Fakultät
            Nachhaltige Infrastruktur befindet sich in Neuburg. Der Stammcampus
            mit Mensa, Bibliothek und den restlichen Fakultäten befindet sich an
            der Esplanade in Ingolstadt.
          </p>
