        ...
        <Card.Body>
          ...
          <Card.Text>
            <a
              ...
              rel="noreferrer"
            >
              {item.organizer} <FontAwesomeIcon icon={faExternalLink} />
            </a>{' '}
            <a
              href={club.instagram}
              target="_blank"
...
function getNeulandCard() {
  return (
    <Card className={styles.card}>
      <Card.Body>
        <Card.Title>
          <h4>Mehr in der Neuland.App</h4>
        </Card.Title>
        <Card.Subtitle>Deine zuverlässige THI-App!</Card.Subtitle>
        <Card.Text>
          <Card.Link href="https://neuland.app">
            JETZT IM BROWSER ÖFFNEN <FontAwesomeIcon icon={faExternalLink} />
          </Card.Link>
        </Card.Text>
      </Card.Body>
    </Card>
  ...
  return (
    <Container className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>Ersti-Hilfe-Kit</h1>

        <p>Willkommen an der Technischen Hochschule Ingolstadt!</p>
        ...
        <p>
          In den folgenden Themenbereichen versuchen wir das wichtigste Know-How
          zu eurem Studierendenleben an der THI zusammenzufassen.
        </p>

        <p>
          <Link href="/guide/studies">
            <Button variant="outline-primary">Zum Guide</Button>
          </Link>
        </p>
        ...
        <p>
          <Link
            ...
            target="_blank"
          >
            <Button variant="outline-primary">Ingolstadt</Button>
          </Link>
        </p>
        ...
        <p>
          <Link
            ...
            target="_blank"
          >
            <Button variant="outline-primary">Neuburg</Button>
          </Link>
        </p>
        ...
        <p className="d-flex gap-1">
          ...
          <Link
            ...
            className="mt-2 pl-2"
          >
            <Button variant="outline-primary">neuland.app</Button>
          </Link>
        </p>
        ...
        <p>
          <a
            href="https://discord.gg/pTvQEZpga7"
            target="_blank"
            rel="noreferrer"
          >
            <Button variant="outline-primary">Fakultät Informatik</Button>
          </a>
        </p>

        <p>
          <a
            href="https://discord.gg/2gzsCD744V"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <p>
          <a
            href="https://discord.gg/gP4hQaxmRS"
            target="_blank"
            rel="noreferrer"
          >
            <Button variant="outline-primary">Fakultät Maschinenbau</Button>
          </a>
        </p>

        <p>
          <a
            href="https://discord.gg/geebhm5UKF"
            target="_blank"
            rel="noreferrer"
          >
            <Button variant="outline-primary">
...
export async function getServerSideProps() {
  ...
  const events = data.clEvents.map((event) => {
    return {
      ...event,
  ...
  const finalRawData = rawData.filter((x) => {
